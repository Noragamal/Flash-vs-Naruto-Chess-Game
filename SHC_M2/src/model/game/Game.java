...
public class Game {
	...
	public void assemblePieces() {
		...
		Armored a1 = new Armored(player1, this, "Hanji");
		...
		Medic m1 = new Medic(player1, this, "Sakura");
		...
		Ranged r1 = new Ranged(player1, this, "Shikamaru");
		...
		Speedster sp1 = new Speedster(player1, this, "Naruto");
		...
		Super su1 = new Super(player1, this, "Ackamaro");
		...
		Tech t1 = new Tech(player1, this, "Kakashi");
